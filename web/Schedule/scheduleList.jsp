...
<jsp:include page="/includes/header.jsp">
    ...
    <div class="container" style="max-width: 900px;">
        <h2>My Consultation Schedules</h2>
        <hr>
        ...
        <form action="ScheduleServlet" method="post">
                ...
                <tbody>
                    <c:forEach var="s" items="${listSchedule}">
                        <tr style="border-bottom: 1px solid #ddd;">
                            ...
                            <td>${s.location}</td>
                            <td>
                                <a href="ScheduleServlet?action=edit&id=${s.scheduleId}" class="btn btn-warning" style="padding: 5px 10px; font-size: 0.8rem;">Edit</a>
                                <a href="ScheduleServlet?action=delete&id=${s.scheduleId}" onclick="return confirm('Are you sure you want to delete this slot?');" class="btn btn-danger" style="padding: 5px 10px; font-size: 0.8rem;">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
            ...
            <br>
            <button type="submit" class="btn btn-danger" onclick="return confirm('Delete all selected schedules?');">Delete Selected</button>
            <a href="ScheduleServlet?action=dashboard" class="btn btn-primary">Back to Dashboard</a>
        </form>
    </div>
